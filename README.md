# Bayer AG (BAYGN) — Equity Risk & Return Analysis
...
1. Monthly closing prices for BAYGN, DAX, and the German 10-year bond yield (April 2021 – April 2026)
2. Simple return computation and excess return calculation using the German 10Y yield as risk-free rate
3. OLS regression of Bayer excess returns on DAX excess returns (CAPM single-factor model)
...
Monthly historical data sourced from [Investing.com](https://www.investing.com/). 60 observations (May 2021 – April 2026).
